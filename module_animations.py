...
["shield_bash", acf_enforce_all|acf_align_with_ground, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
    [1.5, "defend_shield_parry_all", 1, 50, blend_in_defense], #Adjust duration for balance.  Currently at 0.50 seconds, fixed.
    [1.5, "defend_shield_right", 1, 50, blend_in_defense],
    [1.5, "defend_shield_left", 1, 50, blend_in_defense],
    [1.5, "defend_shield_right", 1, 50, blend_in_defense],   
...
["spearwall_hold", acf_thrust|acf_enforce_all|acf_align_with_ground, amf_priority_striked|amf_play|amf_accurate_body|amf_restart,
